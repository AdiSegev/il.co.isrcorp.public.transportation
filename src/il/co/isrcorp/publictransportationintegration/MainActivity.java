...
import il.co.isrcorp.applicationUpdate.UpdateManager;
		...
		public void update(Observable observable, Object data) {
			...
			if (data instanceof EventsFromSPM) {
				...
				case EventsFromSPM.HELLO:
					...
					Utils.logger("got hello in updater");
					break;
				...
				case PublicTransportation.$APP:
					...
					if("UpdateConfig".equalsIgnoreCase(result[1])){
						updater.updateConfigurationReceived(result);
					return;
					}
